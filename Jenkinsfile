            ...
            steps {
                script {
                    sh '''
                            ...
                            aws ecs update-service --cluster cluster-1 --service common --task-definition common:$TASK_REVISION --region us-east-2
                            aws ecs wait services-stable --service common -cluster cluster-1 --region us-east-2
                       '''
                }
            }
        }
